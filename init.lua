...
-- Making vim use 4 spaces when tab will be pressed.
vim.o.expandtab = true
vim.o.tabstop = 4
vim.o.shiftwidth = 4
vim.o.softtabstop = 4

-- Setting up key bingings for the alt + up/down arrow keys to be able to move code around.
...
require('lazy').setup({
  ...
  --
  -- { -- Adds the VimBeGood game by ThePrimeagen which is helpful to practice vim motions and be better.
